...
// ✅ تبويب رئيسية بيحتوي على HomeScreen و Doctorlist
const HomeTab = () => (
  <HomeStack.Navigator screenOptions={{ headerShown: false }}>
    <HomeStack.Screen name="HomeScreen" component={HomeScreen} />
    <HomeStack.Screen name="Doctorlist" component={Doctorlist} />
  </HomeStack.Navigator>
);

// ✅ MainApp بتستخدم التبويبات
const MainApp = () => {
  useEffect(() => {
  ...
  return (
    ...
    >
      <Tab.Screen name="الرئيسية" component={HomeTab} />
  ...
  return (
    <NavigationContainer>
      ...
      <Stack.Navigator initialRouteName="Welcome">
        ...
        <Stack.Screen name="MedicinesScreen" component={MedicinesScreen} options={{ headerShown: false }} />
        <Stack.Screen name="DoctorsList" component={DoctorsListPage} options={{
          headerShown: true,
          title: 'قائمة الأطباء',
        ...
        <Stack.Screen name="EditProfile" component={EditProfile} options={{ title: 'تعديل الملف الشخصي' }} />
        <Stack.Screen name="MyBookings" component={MyBookings} options={{ headerShown: true, title: 'حجوزاتي' }} />
        <Stack.Screen name="MyChats" component={MyChats} options={{ title: 'محادثاتي' }} />
